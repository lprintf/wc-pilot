...
export type User = { id: number; nickname: string; avatar_url: string; last_message_preview: string; last_active_at: string; unread_count: number; latest_intent?: string; discovery_step?: number; scenario?: string }
